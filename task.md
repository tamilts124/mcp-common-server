...
- [ ] Add diff_strings + password_generate tools — status: in-progress
  - notes: diff_strings: in-memory Myers LCS diff of two strings (no file I/O), unified/json output. password_generate: crypto-secure password (charset pools, reject-sampling) + passphrase (512-word embedded list) with entropy estimate.

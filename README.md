...
| `lib/dispatchEmail.js` | Dispatch table wiring `email_list_mailboxes`/`email_search` to `lib/emailOps.js` (mirrors `lib/dispatchBrowser.js` pattern) |
| `lib/schemas/emailSchemas.js` | JSON-RPC input schemas for the two email tools |

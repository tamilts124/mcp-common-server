# 🚀 MCP Common Server (HTTP + SSE) — v3.14.0
...
| `lib/jsonPathOps.js` | JSONPath-style query engine: `query_path` — `$`, `.key`, `['key']`, `[N]`, `[*]` wildcard, `..` recursive descent, on JSON/YAML files |

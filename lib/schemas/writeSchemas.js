...
const WRITE_SCHEMAS = [
  ...
  {
    name: "md_to_pdf",
    description: "Convert a Markdown source file into a PDF file (zero-dependency, hand-built multi-page PDF using the standard-14 Helvetica/Helvetica-Bold fonts, no font embedding). Supports headings (# .. ######, size-scaled), bullet list items (- / *), inline **bold**/*italic* formatting, word-wrap, and automatic page breaks. Not a full CommonMark engine; ASCII/Latin-1 text only. Write-gated: blocked when MCP_READ_ONLY=true.",
    inputSchema: { type: "object", required: ["path", "destination"], properties: {
      path:        { type: "string", description: "Path to the source Markdown (.md) file." },

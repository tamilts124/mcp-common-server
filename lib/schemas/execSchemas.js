          ...
          properties: {
            op: {
              ...
              enum: [
                ...
                "file_checksum", "checksum_verify", "hash_string", "zip_directory", "read_archive", "query_json", "query_data", "query_path", "diff_files", "env_info", "find_duplicates", "compare_directories", "file_diff_dir", "json_diff",
                "count_lines", "file_tree", "hash_directory",
                "base64_encode",
                "file_stats", "scan_todos", "dir_size_stats", "disk_usage_summary", "csv_query", "http_fetch", "port_check", "wait_for_port",
                ...
                "md_to_docx", "docx_to_md", "md_to_pdf", "pdf_to_md",

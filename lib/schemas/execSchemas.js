          ...
          properties: {
            op: {
              ...
              enum: [
                ...
                "file_stats", "scan_todos", "scan_conflict_markers", "scan_secrets", "check_line_endings", "find_large_files", "find_empty_dirs", "package_json_audit", "readme_link_check", "check_branch_protection_hints", "dir_size_stats", "disk_usage_summary", "csv_query", "csv_diff", "http_fetch", "port_check", "wait_for_port", "port_scan_range", "dns_lookup",

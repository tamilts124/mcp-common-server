          ...
          properties: {
            op: {
              ...
              enum: [
                ...
                "file_checksum", "checksum_verify", "hash_string", "zip_directory", "create_tar", "read_archive", "query_json", "query_data", "query_path", "diff_files", "env_info", "system_resources", "find_duplicates", "compare_directories", "file_diff_dir", "json_diff",

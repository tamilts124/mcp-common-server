          ...
          properties: {
            op: {
              ...
              enum: [
                ...
                "file_checksum", "zip_directory", "read_archive", "query_json", "query_data", "query_path", "diff_files", "env_info", "find_duplicates", "compare_directories", "file_diff_dir", "json_diff",

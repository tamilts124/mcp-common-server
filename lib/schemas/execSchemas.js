          ...
          properties: {
            op: {
              ...
              enum: [
                ...
                "json_patch", "apply_patch", "unzip_archive", "extract_tar", "yaml_patch", "yaml_merge", "json_merge", "convert_data", "csv_convert", "http_download",

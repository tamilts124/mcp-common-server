          ...
          properties: {
            op: {
              ...
              enum: [
                ...
                "git_status", "git_log", "git_blame", "git_diff", "git_stash_list", "git_branch_list", "git_worktree_list", "git_show", "git_tag_list", "git_ownership", "git_reflog", "git_dangling_commits", "git_object_count", "git_cherry", "git_untracked_size", "find_stale_branches", "git_commit_message_lint", "check_gitignore_coverage", "git_diff_summary", "git_blame_hotspots", "git_file_age", "find_todo_owners", "generate_pr_description", "find_large_git_objects", "check_lfs_coverage", "merge_conflict_risk", "git_contributors_summary", "find_recent_force_pushes", "check_stash_apply_risk", "git_blame_ownership_diff", "git_tag_annotate_audit", "check_commit_signatures",
                ...
                "file_stats", "scan_todos", "scan_conflict_markers", "scan_secrets", "check_line_endings", "find_large_files", "find_empty_dirs", "package_json_audit", "readme_link_check", "dir_size_stats", "disk_usage_summary", "csv_query", "csv_diff", "http_fetch", "port_check", "wait_for_port", "port_scan_range", "dns_lookup",

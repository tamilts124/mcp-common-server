          ...
          properties: {
            op: {
              ...
              enum: [
                ...
                "git_status", "git_log", "git_blame", "git_diff", "git_stash_list", "git_branch_list", "git_worktree_list", "git_show", "git_tag_list", "git_ownership", "git_reflog", "git_cherry", "git_untracked_size", "find_stale_branches", "git_commit_message_lint", "check_gitignore_coverage", "git_diff_summary", "git_blame_hotspots",
                "file_checksum", "checksum_verify", "hash_string", "zip_directory", "create_tar", "read_archive", "query_json", "query_data", "query_path", "diff_files", "env_info", "env_diff", "system_resources", "which_command", "find_duplicates", "compare_directories", "file_diff_dir", "json_diff", "json_schema_validate", "json_flatten", "json_unflatten", "find_circular_deps",

          ...
          properties: {
            op: {
              ...
              enum: [
                ...
                "file_stats", "scan_todos", "scan_conflict_markers", "scan_secrets", "check_line_endings", "find_large_files", "find_empty_dirs", "package_json_audit", "readme_link_check", "check_package_lock_sync", "scan_dockerfile_issues", "scan_dependency_licenses", "find_case_sensitive_import_mismatches", "scan_cors_misconfig", "scan_dangerous_code_patterns", "check_branch_protection_hints", "find_hardcoded_ips", "find_env_var_usage", "git_hooks_audit", "check_npm_audit_cache", "find_unreachable_modules", "find_orphaned_test_files", "find_missing_await", "check_test_coverage_gaps", "find_duplicate_json_keys", "find_duplicate_yaml_keys", "find_unsafe_regex", "find_unpinned_github_actions", "scan_npm_lifecycle_scripts", "check_semver_range_strictness", "find_empty_catch_blocks", "find_sync_fs_in_async_context", "find_hardcoded_credentials_in_config", "find_hardcoded_ports", "find_dangling_promises", "find_insecure_random_usage", "check_dockerignore_coverage", "dir_size_stats", "disk_usage_summary", "csv_query", "csv_diff", "http_fetch", "port_check", "wait_for_port", "port_scan_range", "dns_lookup",

          ...
          properties: {
            op: {
              ...
              enum: [
                ...
                "git_status", "git_log", "git_blame", "git_diff", "git_stash_list", "git_branch_list", "git_show", "git_tag_list", "git_ownership", "git_reflog", "git_cherry",
                "file_checksum", "hash_string", "zip_directory", "read_archive", "query_json", "query_data", "query_path", "diff_files", "env_info", "find_duplicates", "compare_directories", "file_diff_dir", "json_diff",
                "count_lines", "file_tree", "hash_directory",
                "base64_encode",
                "file_stats", "dir_size_stats", "csv_query", "http_fetch",
                ...
                "browser_list_sessions", "browser_close", "browser_wait_for_selector",
                ...
                "browser_get_local_storage", "browser_set_local_storage", "browser_add_init_script",
                ...
                "browser_frame_type", "browser_frame_get_content",
              ],
            },
            on_error: {
              type: "string",

          ...
          properties: {
            op: {
              ...
              enum: [
                ...
                "git_status", "git_log", "git_blame", "git_diff", "git_stash_list", "git_branch_list", "git_worktree_list", "git_show", "git_tag_list", "git_ownership", "git_reflog", "git_cherry", "git_untracked_size", "find_stale_branches",
                "file_checksum", "checksum_verify", "hash_string", "zip_directory", "create_tar", "read_archive", "query_json", "query_data", "query_path", "diff_files", "env_info", "env_diff", "system_resources", "which_command", "find_duplicates", "compare_directories", "file_diff_dir", "json_diff", "json_schema_validate", "json_flatten", "json_unflatten",
                "count_lines", "file_tree", "hash_directory",
                "base64_encode",
                "file_stats", "scan_todos", "scan_conflict_markers", "scan_secrets", "check_line_endings", "find_large_files", "find_empty_dirs", "package_json_audit", "readme_link_check", "dir_size_stats", "disk_usage_summary", "csv_query", "http_fetch", "port_check", "wait_for_port", "port_scan_range",

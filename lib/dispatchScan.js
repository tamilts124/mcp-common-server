"use strict";
// ── SCAN / STATIC-ANALYSIS TOOL DISPATCH HANDLERS (part 1) ─────────────────
// Split from dispatchScan.js (877 lines, over the 500-line convention).
// Second half lives in lib/dispatchScan2.js, merged back via Object.assign
// below — same pattern as the utilSchemas.js split. Pure move, no behavior
// change.
...
const { SCAN_DISPATCH_2 } = require("./dispatchScan2");
...
Object.assign(SCAN_DISPATCH, SCAN_DISPATCH_2);

"use strict";
// ── CORE READ / UTILITY TOOL DISPATCH HANDLERS ─────────────────────────────────
// Extracted from dispatchRead.js when it exceeded the 500-line threshold.
// Contains: file I/O, search, crypto/JWT/HMAC/TOTP, hashing, compression,
//           diff, env, HTTP fetch/serve/multipart, image_ops, pdf_rich_extract,
//           csv, network utilities (port, dns), and format conversion helpers.
